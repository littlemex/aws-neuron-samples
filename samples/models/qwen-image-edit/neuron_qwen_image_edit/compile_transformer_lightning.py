...
Usage:
    python compile_transformer_lightning.py \
        ...
        --compiled_models_dir /opt/dlami/nvme/compiled_models_lightning
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--compiled_models_dir", type=str, default="/opt/dlami/nvme/compiled_models_lightning")
    parser.add_argument("--compiler_workdir", type=str, default="/opt/dlami/nvme/compiler_workdir_lightning")
