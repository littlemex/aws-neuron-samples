...
COMPILER_WORKDIR="/mnt/local/compiler_workdir"
...
if [[ "$VERSION_MODE" == "v3_tp8" ]]; then
    COMPILED_MODELS_DIR="/mnt/local/compiled_models_tp8"
elif [[ "$VERSION_MODE" == "v3_tp16" ]]; then
    COMPILED_MODELS_DIR="/mnt/local/compiled_models_tp16"
elif [[ "$VERSION_MODE" == "v3_tp32" ]]; then
    COMPILED_MODELS_DIR="/mnt/local/compiled_models_tp32"
else
